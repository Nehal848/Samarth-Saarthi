        ...
        <div className="mb-6 space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full p-3 ps-10 border border-input rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary/30"
              placeholder="Explore..."
            />
          </div>
          ...
          {showFilters && (
            <div className="p-4 rounded-lg border border-border bg-card space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {/* Type Filter */}
                <div>
                  <label className="block text-sm font-medium mb-1">Explore</label>
                  <select 
                    value={filters.type}
