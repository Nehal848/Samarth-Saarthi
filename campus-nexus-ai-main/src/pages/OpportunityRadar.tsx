    ...
    <PageWrapper className="bg-background">
        ...
        <div className="space-y-4">
          {filteredOpportunities.length === 0 ? (
            ...
            filteredOpportunities.map((opportunity, index) => (
              ...
              >
                <Card className="glass-card hover:shadow-card-hover transition-all border border-border/50">
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-background rounded-lg w-full max-w-2xl border max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <select 
                      className="w-full p-2 border border-input rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary/30"
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    className="w-full p-2 border border-input rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary/30 min-h-[100px]"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium">Opportunity URL</label>
                  <Input 
                    type="url"
