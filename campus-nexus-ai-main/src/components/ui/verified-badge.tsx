...
export function VerifiedBadge({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative p-4 rounded-xl border-2 bg-card hover:shadow-card-hover transition-shadow cursor-pointer",
    ...
    >
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full gradient-bg flex items-center justify-center shadow-glow-sm">
